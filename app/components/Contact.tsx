...
function Contact() {
    return (
        <section className='px-6 mb-28 md:mb-32 md:px-20 md:max-w-[686px] md:mx-auto' id='contact'>
            <div className="flex flex-col justify-center items-center">
                <p className="font-para text-base text-accent text-center mb-4">Wanna Have a conversation?</p>
                <h2 className='mb-5 font-heading text-neutral-0 text-center text-[32px] md:text-[4rem]'>Get in Touch</h2>
