...
function Footer() {
    return (
        <div id="footer" className="bg-secondary px-3 py-4">
            <div className="container flex justify-between mx-auto md:px-12">
                <p className="font-para text-neutral-100 text-xs mx-auto">
                    Developed by<a href="https://www.fiverr.com/sreenath_kumar" className="text-accent ml-2" target="_blank" rel="noreferrer">Sreenath Kumar</a>
                </p>
                <div className="hidden">
                    ...
                    <a href="https://twitter.com/sreenathkumar_" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="social_icon">
                            <path
                    ...
                    <a href="https://www.linkedin.com/in/sreenathkumar" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="social_icon">
                    ...
                    <a href="https://github.com/sreenathkumar" target="_blank" rel="noreferrer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" className="social_icon">
                ...
                <p className="font-para text-neutral-100 text-xs hidden">
                    Inspired by<a href="https://brittanychiang.com/" className="text-accent">Brittany Chiang.</a>
                </p>
            </div>
        </div>
    )
