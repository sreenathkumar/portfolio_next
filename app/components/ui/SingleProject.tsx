...
function SingleProject({ project }: { project: ProjectType }) {
    return (
        <div className="flex flex-col w-full h-full p-8 m-auto rounded-lg bg-secondary">
            <div className="flex justify-between items-center mb-6">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 31 28"
                    className="stroke-1 stroke-neutral-100 fill-none text-2xl">
                ...
                <div className='flex gap-2 items-center'>
                    {
                        project.url &&
                        <Link href={project.url} rel='noreferrer' target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 19.207 19.207"
                                className="link_icon stroke-1 stroke-neutral-100 fill-none text-lg">
            ...
            <div className="texts">
                <h3 className="font-heading text-2xl text-accent mb-4">{project.title}</h3>
                <p className="font-para text-base text-neutral-100 mb-6">
                    {project.description}
                </p>
            </div>
            <div className='flex gap-3 flex-wrap items-center mt-auto text-xs text-accent font-para'>
