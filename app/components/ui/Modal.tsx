        ...
        <div className='fixed bottom-0 left-0 z-20 w-full'>
            <AnimatePresence>
                {openModal && <motion.div
                    ...
                    className='flex flex-col text-neutral-100 rounded-t-lg mx-auto bg-secondary md:w-3/5 md:p-10 '>
                    <svg onClick={onDismiss} xmlns="http://www.w3.org/2000/svg" className='ml-auto mb-10' width="24" height="24" viewBox="0 0 24 24"><g fill="currentColor" fillRule="evenodd" clipRule="evenodd"><path d="M5.47 5.47a.75.75 0 0 1 1.06 0l12 12a.75.75 0 1 1-1.06 1.06l-12-12a.75.75 0 0 1 0-1.06" /><path d="M18.53 5.47a.75.75 0 0 1 0 1.06l-12 12a.75.75 0 0 1-1.06-1.06l12-12a.75.75 0 0 1 1.06 0" /></g></svg>
                    {
                        children
                    }
                </motion.div>}
